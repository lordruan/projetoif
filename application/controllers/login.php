...
class Login extends CI_Controller {
	...
	public function Validar() {
		$this->form_validation->set_rules('codigo','codigo','trim|required|callback__check_login');
	...
	public function _check_login($codigo) {
		if($this->input->post('senha')){
			$user = $this->model_users->get_usuario($codigo,$this->input->post('senha'));
				if($user) return true;
		}
		$this->form_validation->set_message('_check_login','Codigo / Senha Errado(s)');
		return false;
	}
