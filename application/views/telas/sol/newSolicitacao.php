...
<?php
	...
	<div class=\"form-group\">";
		...
		echo form_label('Paciente:','paciente',$attr_label);
		...
		echo "</div>";
		echo form_label('UBS:','id_unidade',$attr_label);
		echo "<div class=\"col-lg-4\">";
		echo '<select class="input-large form-control" name="id_unidade" id="ubs" type="text" placeholder=".input-xxlarge" disabled>
			'.$ubs.'
		</select>';
		echo "</div>";
		echo form_label('Tipo Solicitação:','id_tipo_solicitacao_tipo_solicitacao',$attr_label);
		echo "<div class=\"col-lg-4\">";
		...
		echo "</div>";
		echo form_label('Status:','status',$attr_label);
		echo "<div class=\"col-lg-4\">";
		echo 'Status:<select class="input-large form-control" name="status" id="status" type="text" placeholder=".input-xxlarge">
	...
	echo "</div>";
		...
		echo '<div class="form-inline">
			...
			<div class="control-group">';
				echo form_label('Insumo:','id_cad_insumos_cad_insumos',$attr_label);
				echo "<div class=\"col-lg-4\">";
				...
				echo "</div>";
				echo form_label('Observação:','observacao',$attr_label);
				echo "<div class=\"col-lg-4\">";
		...
		foreach ($ok as $linha) {
			...
			$this->table->add_row($linha['id_cad_insumos_cad_insumos'], $linha['quantidade'], $linha['observacao'],$linha['operacoes']);
		}
		if ($fl == 0)
		...
		echo "</div>";
		echo "<div class=\"col-lg-2\">";
		echo form_submit(array('name' => 'btnCadastrar','class' => 'btn btn-primary form-control','onclick' => 'javascript: salvar();'),'Salvar');
		echo "</div>";
		echo "<fieldset>
		</div>"; 
		echo form_close();
...
<script type="text/javascript" charset="utf-8">
	function muda_value()
	{
		...
		document.sol_insumos.adiciona.value=1;
